    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.IntegerField(default=0, max_length=15, choices=[(0, b'Seleccione Sexo'), (1, b'Femenino'), (2, b'Masculino')])),
                ('loyal_user', models.BooleanField(default=False)),
                ('user', models.OneToOneField(to=settings.AUTH_USER_MODEL)),
                ('wish_list', models.ManyToManyField(to='catalog.Product', blank=True)),
            ],
            options={
                'abstract': False,
            },
